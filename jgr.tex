...
PARAPHRASE NOTES FROM BOB





(1) Lots of work has been done with global MHD codes, including on the study of ULF waves. The authors of those studies note significant limitations in their models. Inconsistent whether models produce FLRs. Waves above 20mHz are attenuated by the grid.

(2) Big global MHD codes run into several limitations when looking at ULF waves. Their spatial resolution at the ionosphere is wide, and they don't go down to the atmosphere. This is because of the courant condition. The Alfven speed close to the atmosphere is very fast, so faithful calculation is expensive.

(3) Localized models exist to look specifically at wave propagation in the auroral zone, where the Alfven speed is particularly high.

(4) The present work is a hybrid approach, similar to that used by [...]. Global scope to capture MI coupling, linearized equations, tight resolution in space and time. Intention is to capture transient behavior, not long-term response to solar wind conditions.
